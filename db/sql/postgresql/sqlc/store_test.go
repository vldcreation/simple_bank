...
func TestTransferTx(t *testing.T) {
	...
	account2 := createRandoomAccount(t)
	fmt.Println(">> before: ", account1.Balance, account2.Balance)

	// run the transfer within a transaction
	amount := util.RandAmount()
	...
	for i := 0; i < n; i++ {
		...
		// validae the transfer result was created
		...
		require.True(t, diff1%amount == 0) // amount should be a factor of the balance difference
